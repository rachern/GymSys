layui.use(['table', 'laypage', 'laytpl'], function () {
  ...
  table.render({
    ...
    , cols: [[
      ...
      , { field: 'userName', edit: 'text', title: '用户名', align: 'center' }
      , { field: 'userPassword', edit: 'text', title: '用户密码', align: 'center', templet: '#userPassword' }
      , { field: 'userEmail', edit: 'text', title: '用户邮箱', align: 'center', templet: '#userEmail' }
